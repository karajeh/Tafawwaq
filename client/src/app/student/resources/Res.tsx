...
export default function Res() {
  ...
  const [contactEmail, setContactEmail] = useState("student@email.com");
          ...
          <div className="bg-white xl:w-1/4 md:w-60 w-full p-4 rounded-md shadow-md h-60 overflow-auto">
            <div className="flex flex-col space-y-4 text-gray-600">
              {/* <Link
                ...
                href="/faq"
                className="bg-[#00ADEF] text-white px-4 py-2 rounded-md"
              >
                FAQ
              </Link>
              <Link
              ...
              <button
                ...
                className={`hover:bg-gray-100 px-4 py-2 rounded-md text-left transition duration-300 ease-in-out transform hover:scale-105 active:scale-95 ${
                  option === "FAQ" ? "bg-[#00ADEF] text-white" : ""
                }`}
              >
                FAQ
              </button>
              <button
                ...
                className={`hover:bg-gray-100 px-4 py-2 rounded-md text-left transition duration-300 ease-in-out transform hover:scale-105 active:scale-95 ${
                  option === "Contact" ? "bg-[#00ADEF] text-white" : ""
                }`}
              >
                CONTACT US
              </button>
              <button
                ...
                className={`hover:bg-gray-100 px-4 py-2 rounded-md text-left transition duration-300 ease-in-out transform hover:scale-105 active:scale-95 ${
                  option === "Feedback" ? "bg-[#00ADEF] text-white" : ""
                }`}
              >
                FEEDBACK / SUGGESTION
              </button>
              <button
                ...
                className={`hover:bg-gray-100 px-4 py-2 rounded-md text-left transition duration-300 ease-in-out transform hover:scale-105 active:scale-95 ${
                  option === "Report" ? "bg-[#00ADEF] text-white" : ""
                }`}
              >
                REPORT AN ISSUE
              </button>
          ...
          {option === "FAQ" && (
            <div className="md:w-3/4 w-full md:ml-8 p-6 rounded-md shadow-md">
              ...
              <div className="text-center mt-8 bg-white py-6 rounded-md">
                ...
                <button
                  className="bg-[#A3D154] text-white px-6 py-2 rounded-md mt-4 transition duration-300 ease-in-out transform hover:scale-105 active:scale-95"
            ...
            <div className="md:w-3/4 w-full md:ml-8 rounded-md shadow-md ">
              <div className="flex flex-col justify-start pb-4 items-center ">
                <div
                  ...
                  className="bg-white shadow-xl backdrop-blur-2xl rounded-xl p-6 w-[500px] max-w-[80%]"
                >
                  <form className="flex flex-col gap-6 ">
                    ...
                    <button className=" bg-[#f3f3f3] text-black p-3 rounded-xl transition duration-300 ease-in-out transform hover:scale-105 active:scale-95">
                      Submit
                    </button>
                  </form>
                </div>
            ...
            <div className="md:w-3/4 w-full px-5 md:ml-8 rounded-md shadow-md ">
              <div className="flex flex-col justify-start pb-4 items-center ">
                ...
                <p>
                  ...
                  any concerns related to your experience with Tafawwaq. Our
                ...
                <form className="space-y-6 w-full">
                  ...
                  <div className="flex w-full flex-col items-center xl:items-start xl:flex-row justify-evenly">
                    ...
                    <p className="mt-2 text-gray-600">{selectedFile.name}</p>
                        ...
                        <button className="bg-secondary rounded-md text-white w-full py-3 transition duration-300 ease-in-out transform hover:scale-105 active:scale-95">
                          Upload
                        </button>
                      </div>
                      {/* History Button */}
                      <div>
                        <button
                          type="button"
                          className="w-full p-4 text-left bg-[#A3D1547D] rounded-lg transition duration-300 ease-in-out transform hover:scale-105 active:scale-95"
                        >
                    ...
                    <div className="w-5/6 xl:w-5/12 mt-5 xl:mt-0 flex flex-col gap-5">
                      ...
                      <button
                        type="button"
                        onClick={openModal}
                        className="w-full py-3 bg-[#42ABD1] text-white rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 active:scale-95"
                      >
                        Submit
                      </button>
                      {isModalOpen && (
