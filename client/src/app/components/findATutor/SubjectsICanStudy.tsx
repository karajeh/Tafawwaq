...
const SubjectsICanStudy: React.FC<Props> = ({
  ...
  const [isLevelVisible, setIsLevelVisible] = useState(selectedLevels.length > 0 ? true : false );
  const [isSubjectVisible, setIsSubjectVisible] = useState(selectedSubjects.length > 0 ? true : false);
