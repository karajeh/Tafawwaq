...
const styles = {
  base: [
    // Base
    "relative isolate inline-flex items-center justify-center gap-x-2 rounded-xl border text-base/6 font-semibold",
    // Sizing
    "px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-6 sm:py-[calc(theme(spacing[1.5])-1px)] sm:text-sm/6",
    // Focus
  ...
  outline: [
    // Base
    "border-button_primary text-button_primary data-[active]:bg-button_primary/[2.5%] data-[hover]:bg-button_primary/[2.5%]",
    // Dark mode
  ...
  colors: {
    ...
    button_primary: [
      "text-white [--btn-bg: theme(colors.button_primary)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]",
      "dark:text-white dark:[--btn-bg:theme(colors.zinc.600)] dark:[--btn-hover-overlay:theme(colors.white/5%)]",
      "[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)]",
    ],
    light: [
