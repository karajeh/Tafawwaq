...
export function NavbarSection({
  ...
  return (
    <LayoutGroup id={id}>
      <div
        {...props}
        className={clsx(className, "flex items-center gap-3 w-full")}
      />
    </LayoutGroup>
  );
}
...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  const classes = clsx(
    ...
    // Hover
    "data-[hover]:bg-zinc-950/5 data-[hover]:scale-105 data-[slot=icon]:*:data-[hover]:fill-zinc-950",
    // Active
    "data-[active]:bg-zinc-950/5 data-[active]:scale-95 data-[slot=icon]:*:data-[active]:fill-zinc-950",
    // Dark mode
